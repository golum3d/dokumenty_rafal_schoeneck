                                ...
                                <div class="flex items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form method="POST" action="{{ route('documents.categories.destroy', $category) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 transition hover:bg-rose-100">{{ __('document_categories.buttons.delete') }}</button>
                                        </form>
                                    </div>
                                </div>
                            @endforeach
